...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
      ...
      { -- Left widgets
        ...
        logout_menu_widget{
            font = 'Roboto',
            onlock = function() awful.spawn.with_shell('betterlockscreen -l blur') end

      },
        wibox.container.margin(s.mytaglist),
        wibox.container.margin(s.mypromptbox, 0, 0),
      },
      {-- Middle widgets
      ...
      { -- Right widgets
        layout = wibox.layout.fixed.horizontal,
        wibox.container.margin(wibox.widget.systray(), 0, 5, 2, 2), -- 5px margin on the right
        wibox.container.margin(s.mylayoutbox, 0, 5, 2, 2),
      },
  }
end)
-- }}}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Mod1"    }, "l", function () awful.spawn.with_shell("betterlockscreen -l blur") end,
    ...
    awful.key({ modkey }, "r", function ()
        awful.spawn.with_shell("redshift -O 3500") end,
              {description = "toggle redshift", group = "utils"}),
    -- Toggle Redshift off
    awful.key({ modkey, "Shift"  }, "r", function ()
        awful.spawn.with_shell("redshift -x") end,
              {description = "toggle redshift off", group = "utils"}),
